	...
	public partial class Weapons : AnimatedSprite2D
	{
		...
		public bool attack()
		{
			...
			if (IsMeelee)
			{
				...
				direction = Vector2.Zero;
				bool hasInput = GetAimDirection() != Vector2.Zero
					|| Input.IsActionJustPressed("shot_right")
					|| Input.IsActionJustPressed("shot_left")
					|| Input.IsActionJustPressed("shot_up")
					|| Input.IsActionJustPressed("shot_down");
